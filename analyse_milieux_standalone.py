...
laz_to_gpd = processing.run("pdal:exportvector", {'INPUT':input,'ATTRIBUTE':[],'FILTER_EXPRESSION':'','FILTER_EXTENT':None,'OUTPUT':'TEMPORARY_OUTPUT'})
...
processing.run("native:kmeansclustering", {'INPUT':laz_to_gpd,'CLUSTERS':2,'FIELD_NAME':'groupe','SIZE_FIELD_NAME':'CLUSTER_SIZE','OUTPUT':'ogr:dbname=\''+section_path+'/temp.gpkg\' table="Clusters" (geom)'})
